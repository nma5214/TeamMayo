...
SLOTS2 = 5 # number of available room per day for process 2. We will multiply work hour 9 later
COLLECTIONS = 5 # the max number of collections a patient needs
NEXT_DAY_P = .1 # the probability that the current day has been passed and we will start a new day
...
class TwoSchechEnv(gym.Env): #set up the environment
    ...
    def updateRemainingSlots(self):
        self.remainingSlots1 -= 1 * self.currentpatient_collection_day
